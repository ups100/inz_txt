...
\caption[Wymagania systemu monitorowania klienta mobilnego]{\raggedleft{Wymagania systemu monitorowania klienta mobilnego}} \label{tab:Wymagania} \\ 
  \hline
...
%link do wykorzystania icingi w cernie
